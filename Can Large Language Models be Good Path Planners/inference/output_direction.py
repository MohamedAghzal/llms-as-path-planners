...
with open('../single_goal/6x6worlds/test_seen.json') as f:
    ...
    for data_point in data:
        ...
        acts.append(solution_direction(data_point['agent_as_a_point']))
...
model = BartForConditionalGeneration.from_pretrained('../train/BART_base_single_goal_direction/checkpoint-34000')
out = []
